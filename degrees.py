...
def shortest_path(source, target):
    ...
    while True:
        ...
        # If there is nothing else in the frontier, there is no solution
        if frontier.empty():
        ...
        for movie, person in neighbors_for_person(node.state):
            if not frontier.contains_state(node.state) and person not in exploredStates:
